...
def main() -> None:
    ...
    parser.add_argument("--csv", type=Path, default='/ailab/group/medai-share/syDu/Brain_EC/ADNI/Process/dataset_index.csv', help="清单CSV，包含列：patient_id, modality, time, nifti_path")
    parser.add_argument("--outdir", type=Path, default='/ailab/group/medai-share/syDu/Brain_EC/ADNI/ADNI_AAL3_CSV', help="输出目录（保存 <patient_id>_<time>.csv 与日志）")
