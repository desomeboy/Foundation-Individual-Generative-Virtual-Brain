...
def run_shap(model: nn.Module, X: np.ndarray, out_dir: str):
    ...
    if ft == "ALL":
        ...
        plt.figure(figsize=(6, 12))  # 宽 x 高（单位：英寸）
        ...
        plt.figure()
        shap.summary_plot(shap_region_top15, X_region_top15, feature_names=region_names_top15, show=False, plot_type="bar", max_display=25)
        plt.tight_layout()
